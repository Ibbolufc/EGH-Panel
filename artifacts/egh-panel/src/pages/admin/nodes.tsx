...
export default function AdminNodes() {
  ...
  async function handleOpenInstall(nodeForInstall: any) {
    if (nodeForInstall.registrationToken) {
      setInstallNode(nodeForInstall);
      return;
    }
    try {
                  ...
                  <div className="mt-3 pt-2.5 border-t border-border/40 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        data-testid={`button-install-node-${node.id}`}
                      >
