              ...
              <div className="border-t border-border/40 px-4 py-4 space-y-4 bg-white/2">
                {[
                  ...
                  },
                  {
                    ...
                    note: `Create /etc/egh-node/config.yml with remote: "${panelUrl}" and token: "${node.registrationToken}". The auto-install script above generates this file automatically.`,
                  },
                  {
